...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/dist/css/index_conteudo/index_conteudo.css') }}">

    <script src="{{ asset('assets/js/color-modes.js') }}"></script>
    <script src="{{ asset('assets/dist/js/index_estudo/script.js') }}"></script>
...
<body>
    ...
    {{--  <!-- Barra de progresso de acordo com o scroll do mouse -->  --}}
    ...
    {{--  Exibição de conteúdo com base na cor da página  --}}
    ...
    <main class="d-flex flex-nowrap card-main">
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px">
            ...
            <hr>
            <ul class="nav nav-pills flex-column mb-auto block">
